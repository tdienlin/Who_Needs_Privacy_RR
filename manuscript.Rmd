...
A list of all items that we were used are reported in the online supplementary material. 
...
In any case, our results argue for a more rather than less nuanced strategy for measuring privacy attitudes.
...
The data are shared as a scientific use file on AUSSDA [@dienlinNeedPrivacyPersonality2024].
