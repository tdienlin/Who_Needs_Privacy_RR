...
The HEXACO model is in the tradition of Big Five approach [@johnBigFiveTrait1999], and it represents a broad understanding of personality.
It measures overall six factors (see below), which have four specific facets each. 
Building not only on factors but also facets seems helpful because we do not expect that need for privacy will relate closely to the overarching factors.
...
Notably, in addition to the Big Five the HEXACO model includes a sixth factor labeled Honesty Humility, plus a facet labeled Altruism, which together seem promising to investigate the nothing to hide argument. 
