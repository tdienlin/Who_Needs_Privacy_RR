...
One could even make the case that need for privacy and extraversion are conceptually the same, and that need for privacy is just a different label for the same underlying personality trait. 
Interestingly, we are not aware of a personality inventory that explicitly refers to privacy.
