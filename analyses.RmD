...
- We'll later conduct additional analyses, for example model-alterations given misfit.

# Set-Up

```{r r-setup, include=T, echo=F}
# install packages
...
A 5% error rate would imply collecting 1.293 participants.
